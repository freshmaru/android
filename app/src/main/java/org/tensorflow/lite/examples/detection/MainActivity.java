...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordButton.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, DetectorActivity.class)));
        ...
        this.sourceBitmap = Utils.getBitmapFromAsset(MainActivity.this, "detective.png");
    ...
    private Button recordButton, detectButton;
