...
//        int[] intValues = new int[INPUT_SIZE * INPUT_SIZE];
    ...
    public ArrayList<Recognition> recognizeImage(Bitmap bitmap) {
        ...
        HashMap<String,String> nameMap = new HashMap<String,String>(){{
            ...
            put("10005", "car");
            put("10006", "meatballs");
            put("10007", "marinara sauce");
            put("10008", "tomato soup");
            put("10009", "chicken noodle soup");
            put("10010", "french onion soup");
            put("10011", "chicken breast");
            put("10012", "ribs");
            put("10013", "pulled pork");
            put("10014", "hamburger");
            put("10015", "cavity");
            put("10016", "anger");
            put("10017", "anxiety");
